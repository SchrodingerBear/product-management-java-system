...
public class Login extends JFrame {
    ...
    public Login() {
        ...
        URL imagelogin = Project.class.getResource("/key.png");
        ImageIcon keylogin = new ImageIcon(imagelogin);
        Image keyimage = keylogin.getImage();

        // Get the scaled instance of the image
        Image scaledImage = keyimage.getScaledInstance(30, 30, Image.SCALE_SMOOTH);
